    ...
    if is_depot then
        ...
        for signal, count in pairs(signals_filtered) do
            ...
            elseif (useRequestStackThreshold and stack_count * -1 >= requesting_threshold_stacks) or
                ...
                global.Dispatcher.Requests[#global.Dispatcher.Requests + 1] = { age = global.Dispatcher.RequestAge[ageIndex], stopID = stopID, priority =
                ...
                if debug_log then
                    ...
                    global.Dispatcher.RequestAge[ageIndex] .. '/' .. game.tick .. ', trains en route: ' .. trainsEnRoute)
                end
            end
